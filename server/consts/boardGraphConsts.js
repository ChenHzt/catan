const hexasData = [
  ...
  { location: { x: 1, y: 0, z: -1 }, vertices: [4, 5, 6, 12, 13, 14] },
  { location: { x: -3, y: 4, z: -1 }, vertices: [7, 8, 9, 17, 18, 19] },
  { location: { x: -2, y: 3, z: -1 }, vertices: [9, 10, 11, 19, 20, 21] },
  ...
  { location: { x: 0, y: -1, z: 1 }, vertices: [22, 23, 24, 33, 34, 35] },
  { location: { x: 1, y: -2, z: 1 }, vertices: [24, 25, 26, 35, 36, 37] },
  { location: { x: -4, y: 3, z: 1 }, vertices: [28, 29, 30, 38, 39, 40] },
  { location: { x: -3, y: 2, z: 1 }, vertices: [30, 31, 32, 40, 41, 42] },
  ...
  { location: { x: -1, y: -2, z: 3 }, vertices: [43, 44, 45, 51, 52, 53] },
];
